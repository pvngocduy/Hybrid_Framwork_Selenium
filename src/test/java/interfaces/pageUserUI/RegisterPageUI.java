...
public class RegisterPageUI {
    public static final String FIRST_NAME_TEXT_BOX = "xpath=//input[@name='FirstName']";
    ...
    public static final String CONFIRM_PASSWORD_TEXT_BOX = "xpath=//input[@id='ConfirmPassword']";
    ...
    public static final String EXIST_MAIL_ERROR_MESSAGE = "xpath=//div[contains(@class, 'message-error')]//li";
}
