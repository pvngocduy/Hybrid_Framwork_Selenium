...
import actions.Utils.extentreports.ExtentManager;
import actions.Utils.extentreports.ExtentTestListener;

import static actions.Utils.extentreports.ExtentManager.createExtentReports;
...
public class ReportListener extends BaseTest implements ITestListener {
    ...
    public void onTestFailure(ITestResult iTestResult) {
        ...
        driver = ((BaseTest) testClass).getDriverInstance();

        Log.error(getTestName(iTestResult) + " test is failed.");

        ExtentTestManager.addScreenShot(driver,Status.FAIL, getTestName(iTestResult));
