...
public class PropertiesFile {
    ...
    static String projectPath = GlobalConstant.PROJECT_PATH;
    ...
    public static void setPropertiesFile() {
        ...
        try {
            ...
            fileIn = new FileInputStream(GlobalConstant.PROPERTIES_FILE_PATH);
    ...
    public static void setPropValue(String KeyProp, String Value) {
        try {
            ...
            fileOut = new FileOutputStream(GlobalConstant.PROPERTIES_FILE_PATH);
